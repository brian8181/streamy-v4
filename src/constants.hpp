...
enum token_id : unsigned long
    ...
    ID_MODIFIER_CAPATIALIZE = 0x100000016ul,
    ID_MODIFIER_INDENT      = 0x100000020ul,
    ID_MODIFIER_LOWER       = 0x100000003ul,
    ID_MODIFIER_UPPER       = 0x100000006ul,
    ID_MODIFIER_TRUNCATE    = 0x100000009ul,
	...
	ID_UNESCAPED_TEXT    = 0x100000012ul,
    ID_INCLUDE_FILE            = 0x100000023ul
    };
